...
│   ├── MixingManager.cs               # Auto-mixing lifecycle with configurable coordinator URL and round activity tracking
│   ├── WalletSyncBackgroundService.cs # Background UTXO sync + real-time blockchain monitoring
│   └── wwwroot/index.html             # Tab-based responsive dashboard (Overview, Send/Receive, UTXOs, CoinJoins, Settings) with SSE, coin control, auto-mixing, QR receive, fee estimation, full send, PSBT, and privacy meter
