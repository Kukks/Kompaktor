...
│   └── wwwroot/index.html             # Dark-themed responsive dashboard with SSE, coin control, auto-mixing, QR receive, fee estimation, full send, and privacy meter
