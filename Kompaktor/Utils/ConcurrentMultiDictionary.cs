...
// // based on https://stackoverflow.com/a/60719233/275504
...
//                 if (!bag.IsDiscarded)
//                 {
//                     return values.Aggregate(false, (current, value) => current || bag.Add(value));
//                 }
//             }
//
//             spinWait.SpinOnce();
...
//     }
//
//     public bool Remove(TKey key, out TValue[]? removedValues)
//     {
//         if (_dictionary.TryRemove(key, out var currentBag))
//         {
//             removedValues = currentBag.ToArray();
//             return true;
//         }
//         removedValues = null;
//         return false;
